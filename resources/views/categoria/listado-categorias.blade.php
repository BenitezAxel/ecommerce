...
<ol class="toolbar">
    <li class="btn-item"><a title="Nuevo" href="/admin/categoria/nuevo" class="fas fa-plus" aria-hidden="true"><span>Nuevo</span></a></li>
        ...
        <form id="form1" method="POST">
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    <label>Listado de Categoria: *</label>
                    <select id="lstCategorias" name="lstCategorias" class="form-control" required>                       
                    </select>
                </div>               
            </div>
